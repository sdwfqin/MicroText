...
public class DotItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public static class Builder {
        ...
        public Builder setTopDistance(float distance) {
            itemDecoration.mTopDistance = ConvertUtils.dp2px(distance);
            return this;
        }

        public Builder setItemPaddingLeft(float itemPaddingLeft) {
            itemDecoration.mItemPaddingLeft = ConvertUtils.dp2px(itemPaddingLeft);
            return this;
        }

        public Builder setItemPaddingRight(float itemPaddingRight) {
            itemDecoration.mItemPaddingRight = ConvertUtils.dp2px(itemPaddingRight);
            return this;
        }

        public Builder setItemInterVal(float interval) {
            itemDecoration.mItemInterval = ConvertUtils.dp2px(interval);
            return this;
        }

        public Builder setLineWidth(float lineWidth) {
            itemDecoration.mLineWidth = ConvertUtils.dp2px(lineWidth);
            return this;
        }
        ...
        public Builder setDotRadius(int dotRadius) {
            itemDecoration.mDotRadius = ConvertUtils.dp2px(dotRadius);
            return this;
        }
        ...
        public Builder setTextSize(float textSize) {
            itemDecoration.mTextSize = ConvertUtils.sp2px(textSize);
            return this;
        }

        public Builder setDotPaddingText(float dotPaddingText) {
            itemDecoration.mDotPaddingText = ConvertUtils.dp2px(dotPaddingText);
            return this;
        }

        public Builder setBottomDistance(float bottomDistance) {
            itemDecoration.mBottomDistance = ConvertUtils.dp2px(bottomDistance);
            return this;
        }
